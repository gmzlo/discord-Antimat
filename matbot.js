...
if (GuildName === "ng") {
	msg.channel.send(`Дорогие Друзья Администрация Сервера(Дискорд) **${msg.guild.name}** поздравляет вас хоть и с Новым Годом и Желает всего самого наилучшего в этому Году :D `, {
		files: [
		  "./img/Kzng.png"
		]
	  }); 
